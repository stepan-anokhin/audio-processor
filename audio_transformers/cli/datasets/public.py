...
DEFAULT_DATASETS: Tuple[DatasetSource, ...] = (
    ...
    DatasetSource(
        name="audiobook_2",
        url="https://azureopendatastorage.blob.core.windows.net/openstt/ru_open_stt_opus/archives/private_buriy_audiobooks_2.tar.gz",
        # noqa: E501
        format="opus",
        size=162000000000,
    ...
    DatasetSource(
        ...
        url="https://azureopendatastorage.blob.core.windows.net/openstt/ru_open_stt_opus/archives/public_youtube1120.tar.gz",
        # noqa: E501
        format="opus",
        size=237000000000,
    ...
    DatasetSource(
        ...
        url="https://azureopendatastorage.blob.core.windows.net/openstt/ru_open_stt_opus/archives/asr_public_phone_calls_2.tar.gz",
        # noqa: E501
        format="opus",
        size=66000000000,
    ...
    DatasetSource(
        ...
        url="https://azureopendatastorage.blob.core.windows.net/openstt/ru_open_stt_opus/archives/public_youtube1120_hq.tar.gz",
        # noqa: E501
        format="opus",
        size=31000000000,
    ...
    DatasetSource(
        ...
        url="https://azureopendatastorage.blob.core.windows.net/openstt/ru_open_stt_opus/archives/asr_public_stories_2.tar.gz",
        # noqa: E501
        format="opus",
        size=9000000000,
    ...
    DatasetSource(
        ...
        url="https://azureopendatastorage.blob.core.windows.net/openstt/ru_open_stt_opus/archives/tts_russian_addresses_rhvoice_4voices.tar.gz",
        # noqa: E501
        format="opus",
        size=80900000000,
    ...
    DatasetSource(
        ...
        url="https://azureopendatastorage.blob.core.windows.net/openstt/ru_open_stt_opus/archives/public_youtube700.tar.gz",
        # noqa: E501
        format="opus",
        size=75000000000,
    ...
    DatasetSource(
        ...
        url="https://azureopendatastorage.blob.core.windows.net/openstt/ru_open_stt_opus/archives/asr_public_phone_calls_1.tar.gz",
        # noqa: E501
        format="opus",
        size=22700000000,
    ...
    DatasetSource(
        ...
        url="https://azureopendatastorage.blob.core.windows.net/openstt/ru_open_stt_opus/archives/asr_public_stories_1.tar.gz",
        # noqa: E501
        format="opus",
        size=4100000000,
    ...
    DatasetSource(
        ...
        url="https://azureopendatastorage.blob.core.windows.net/openstt/ru_open_stt_opus/archives/public_series_1.tar.gz",
        # noqa: E501
        format="opus",
        size=1900000000,
    ...
    DatasetSource(
        ...
        url="https://azureopendatastorage.blob.core.windows.net/openstt/ru_open_stt_opus/archives/public_lecture_1.tar.gz",
        # noqa: E501
        format="opus",
        size=700000000,
